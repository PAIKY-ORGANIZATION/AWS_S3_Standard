...
import { multerMemory, uploadSingle } from '../middleware/multer.js';
...
router.post(
	'/put-object-single',
    uploadSingle('myFieldKey'),
    multerMemory.single('myFieldKey'),
	validate(putObjectSingleController, request_putObjectSingleSchema)
);
